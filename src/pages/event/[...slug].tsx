...
export default function PostSlugRoute(
  ...
  const [isApplicationPopUpOpen, setApplicationPopUpOpen] =
  ...
  return (
    <>
      <EventApplicationPopUp
        isOpenOuter={isApplicationPopUpOpen}
        onIsOpenChange={setApplicationPopUpOpen}
      />
      <Layout>
        <div className="flex w-full my-[5%] justify-center">
          <div className="bg-black bg-opacity-70 rounded-2xl w-full md:w-3/5 mx-5 md:mx-auto p-5">
            <h1 className="text-3xl mb-5 text-center lg:hidden">
              {event.title}
            </h1>
            ...
            <div className="flex justify-center my-5">
              <Button
                onClick={() => setApplicationPopUpOpen(true)}
                className="text-[#3DCAB1] font-bold"
              >
                {/*Todo Localiazation */}
                Jelentkezés
              </Button>
