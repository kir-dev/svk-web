  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          <div
            className={`w-full md:w-3/4 lg:w-1/2 max-h-screen h-auto bg-slate-800 fixed inset-x-0 mx-auto rounded-lg py-8 pb-32  md:pb-8 my-5 text-white transition-all duration-500 overflow-y-auto ${isOpen ? 'scale-100 opacity-100' : 'scale-125 opacity-0'}`}
          >
