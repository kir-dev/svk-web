...
export const ContactPopUp = () => {
  ...
  return (
    <Fragment>
      ...
      >
        <div
          className={`w-screen h-screen backdrop-blur-2xl bg-gray-500 fixed inset-0 z-50 overflow-y-auto transition ease-out duration-300 ${isOpen ? 'bg-opacity-25' : 'bg-opacity-0'}`}
        >
          <div
